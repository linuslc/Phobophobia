...
namespace AC
{
	...
	public class ActionComment : Action
	{
		 ...
		 * <param name = "isWarning">If True, the text will display as a Warning. Otherwise, it will display as Info</param>
		 * <returns>The generated Action</returns>
		 */
		public static ActionComment New (string text, bool isWarning = false)
		{
			ActionComment newAction = (ActionComment) CreateInstance <ActionComment>();
			newAction.commentText = text;
			newAction.acLogType = (isWarning) ? ACLogType.AsWarning : ACLogType.AsInfo;
			return newAction;
		}
